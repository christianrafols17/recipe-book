...
const About = () => {
  return (
    <div name="About" className='w-full min-h-screen bg-gradient-to-b from-white to-gray-400 px-4 md:px-24 pt-24'>
        <div className='flex flex-col'>
            <h1 className='text-4xl font-bold pb-10'>About Us</h1>
            <div className='flex flex-col md:px-12 gap-6 md:gap-10 text-justify'>
